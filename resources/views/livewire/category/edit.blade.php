<div wire:ignore.self class="modal fade" id="editCategory" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model='category_name'
                            class="form-control @error('category_name') is-invalid @enderror" id="exampleInputText"
